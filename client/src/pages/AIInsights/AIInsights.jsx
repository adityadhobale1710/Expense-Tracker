    ...
    <div className="space-y-6 animate-fade-in">
      <div className="page-header flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="page-subtitle">Smart subscription audits, financial waste detection, and AI goal optimization</p>
        </div>
      </div>
      ...
      <div className="card min-h-[420px] flex flex-col items-center justify-center text-center p-8 sm:p-12 relative overflow-hidden border border-slate-800">
        ...
        <p className="text-sm text-slate-400 max-w-lg mb-8 leading-relaxed">
          We are currently training our AI models to provide real-time spending anomaly detection, recurring bill audits, and personalized wealth optimization algorithms.
        </p>
